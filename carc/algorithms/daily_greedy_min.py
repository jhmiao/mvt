...
from .continuous import continuous_algorithm
...
def daily_greedy_heuristic (data: ProblemData, work_limit, seed_number, event_limit=None, pruning=1, update_max_hour = False, min_hour=0):
    """
    ...
    # define custom day order by ascending number of events
    custom_day_order = sorted(range(days), key=lambda d: day_event_counts[d])
