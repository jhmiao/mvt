...
def continuous_algorithm_heuristic (data: ProblemData, work_limit, seed_number, event_limit=None, pruning=False, min_hour=0):
    """
    ...
    for run_id in custom_day_order:
        ...
        event_index = np.concatenate([events_today, [m, m+1]])
